...
const Cart = () => {
  return (
    <div className="bg-blue-950 text-white font-sans">
          ...
          <div className="h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="flex items-center gap-3">
                <button className="px-5 py-2.5 rounded-full border border-gray-300 text-gray-800 hover:border-gray-400 hover:bg-gray-50 transition">
                  Request Quote
                </button>
                <a
                  href="#cta"
                  className="px-5 py-2.5 rounded-full text-white font-medium bg-gradient-to-r from-sky-500 to-indigo-600 hover:shadow-md transition"
                >
                  Get Started
                </a>
              </div>
      ...
      <section className="pb-24 relative">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Product Info */}
            <div>
              <span className="text-neonBlue mb-4 inline-block text-sm sm:text-base">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                >
                  ...
                  <span className="ml-2 text-xs bg-white/20 px-2 py-0.5 rounded-full group-hover:bg-white/30">
                    PDF • 2MB
                  </span>
                </a>

                {/* Request Info Button */}
                <button className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full border-2 border-white/70 text-white font-semibold overflow-hidden transition-all hover:scale-105 hover:border-cyan-400 hover:text-cyan-400 active:scale-95">
                  <span className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent opacity-0 group-hover:opacity-10 transition-opacity"></span>
                  <i className="fas fa-info-circle text-lg group-hover:animate-pulse"></i>
      ...
      {/* Future sections (Highlights, Specs, Support, Related Products) can follow same responsive grid pattern */}
    </div>
  );
};
