...
const HandHeldPage = () => {
  return (
    <div className="bg-gray-900 text-white font-sans">
      ...
      {/* ✅ Hero Section */}
      <section id="category-hero" className="pt-32 pb-24 relative">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {metals.map((metal) => (
              <div
                key={metal.id}
                className="bg-gradient-to-b from-gray-800 to-gray-700 rounded-3xl border border-blue-500/30 
      ...
      <section id="cta-strip" className="py-16 bg-gradient-to-r from-blue-500/40 to-sky-400/20 border-y border-blue-500/30">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-8">Need help choosing the right HHMD model?</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button className="text-gray-900 px-8 py-4 rounded-full hover:bg-blue-400 border hover:text-white transition">
              <FontAwesomeIcon icon={faHeadset} className="mr-2" /> Talk to an Expert
            </button>
            <button className="border-2 border-white px-8 py-4 rounded-full hover:border-blue-400 hover:text-blue-400 transition">
