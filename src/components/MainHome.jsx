...
// ✅ Image imports (make sure assets exist in src/assets)
  ...
  const products = [
    {
      ...
      description:
        "Advanced walk-through detection systems for comprehensive security screening.",
    ...
    },
    {
      ...
      description:
        "Portable detection solutions for precise security screening.",
    ...
    },
    {
      ...
      description:
        "Specialized footwear scanning technology for thorough security checks.",
    ...
    },
    {
      title: "Smart DFMD",
      description:
        "Next-generation detection with touch LCD interface and modular design.",
  ...
  const features = [
    {
      ...
      description:
        "Cutting-edge detection systems powered by advanced algorithms and precision engineering.",
    },
    {
      icon: "🛡️",
      title: "Reliable Performance",
      description:
        "Trusted by global institutions with proven track record of consistent, accurate detection.",
    },
    {
      icon: "📞",
      title: "Dedicated Support",
      description:
        "24/7 expert assistance with comprehensive training and ongoing technical support.",
    },
  ];
    ...
    <div className="bg-slate-950 text-white font-sans">
      ...
      <section className="relative h-screen">
        <Carousel
          ...
          emulateTouch
        >
          {[hero, hero1, hero2, hero3, hero4].map((image, index) => (
            <div
              key={index}
            ...
            >
              {/* Overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-slate-900/50 via-blue-900/40 to-slate-900/50"></div>
              ...
              <div className="container mx-auto px-6 relative z-10 flex items-center h-full">
                <div className="max-w-4xl">
                  ...
                  <p className="text-xl md:text-2xl mb-12 max-w-3xl text-gray-300 leading-relaxed">
                    Advanced detection systems designed for modern security
                    challenges.
                  </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product, index) => (
              <Link
                to={product.link}
                key={index}
                className="block bg-gradient-to-b from-slate-800/80 to-slate-800/60 p-8 rounded-3xl border border-cyan-400/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-400/20 transition-all duration-500 transform hover:-translate-y-2"
              >
                <img
                  src={product.img}
                  alt={product.title}
                ...
                <button className="text-cyan-400 group-hover:text-white transition-colors duration-300 font-semibold">
                  View Products →
                </button>
              </Link>
            ))}
          ...
          <div className="flex overflow-x-auto gap-8 pb-4">
            {products.map((product, index) => (
              <Link
                to={product.link}
                key={index}
                className="min-w-80 bg-gradient-to-b from-slate-800/80 to-slate-800/60 p-6 rounded-2xl border border-cyan-400/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-400/20 transition-all duration-500 transform hover:-translate-y-2"
              >
                <img
                  src={product.img}
                  alt={product.title}
                ...
                <Link to={"/cart"}>
                  <button className="bg-cyan-500 px-6 py-2 rounded-full hover:bg-blue-600 transition-all">
                    View Details
                  </button>
                </Link>
              </Link>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="text-center p-8 bg-gradient-to-b from-slate-800/80 to-slate-800/60 rounded-3xl border border-cyan-400/30 hover:border-cyan-400 hover:shadow-2xl hover:shadow-cyan-400/20 transition-all duration-500 transform hover:-translate-y-2"
              >
      ...
      {/* ✅ CTA Section */}
      <section className="py-24 bg-gradient-to-r from-blue-600/40 to-sky-500/20 border-y border-cyan-400/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              We are pioneers in advanced detection technology, developing
              cutting-edge security solutions that protect what matters most. Our
              commitment to innovation drives us to create systems that are not
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-left">
              <div>
                ...
                <p className="text-cyan-400 hover:underline cursor-pointer">
